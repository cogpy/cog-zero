/*
 * Minimal zero-dependency test runner for agentzero-integration.
 * Compatible with other agentzero-* module test runners.
 */
#pragma once
...
#define ASSERT_NEAR(a,b,eps) aztest::expect(std::fabs((double)(a)-(double)(b))<=(double)(eps), \
    "ASSERT_NEAR(" #a "," #b ")", __FILE__, __LINE__)
