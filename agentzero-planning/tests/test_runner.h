/*
 * Minimal zero-dependency test runner for agentzero-planning.
...
#define ASSERT_NEAR(a,b,eps) aztest::expect(std::fabs(static_cast<double>(a)-static_cast<double>(b))<=static_cast<double>(eps), "ASSERT_NEAR(" #a "," #b ")", __FILE__, __LINE__)
