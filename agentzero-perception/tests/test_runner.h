/*
 * Minimal zero-dependency test runner for agentzero-perception.
...
#define ASSERT_NEAR(a,b,eps) aztest::expect(std::fabs((a)-(b))<=(eps), "ASSERT_NEAR(" #a "," #b ")", __FILE__, __LINE__)
